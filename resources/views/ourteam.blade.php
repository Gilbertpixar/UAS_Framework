...
@section('content')
    <section class="ourteam my-5 pt-1" id="ourteam" style="background-color: rgb(218, 218, 218)">
                        ...
                        @foreach ($rosters as $roster)
                            <div class="col">
                                <div class="card" style="width: 18rem;">
                                    @if ($roster->images)
                                        <img src="{{ Storage::url($roster->images) }}" class="card-img-top"
                                            alt="{{ $roster->nama_rooster }}">
                                    @else
                                        <div class="card-img-top bg-secondary text-light d-flex justify-content-center align-items-center"
                                            style="height: 200px;">
                                            No Image
                                        </div>
                                    @endif
